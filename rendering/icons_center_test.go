...
/* image：sun 左上装饰 + mnt 水平线（避开 rotate） */
...
.ic-image .mnt{position:absolute;left:4px;top:11px;width:8px;height:2px;background:#5d8df0}
...
`)
	...
	t.Log("saved icons_center_test.png")
}
