...
func TestCaretSingleLineInput(t *testing.T) {
	...
	off := rendering.CalcFormControlCaretOffset(text, false, boxX+padX, boxY, boxX, boxY, 200, font, padX, padY, lineH, 0, 0)
	if off != 0 {
	...
	off = rendering.CalcFormControlCaretOffset(text, false, boxX+padX+totalW, boxY, boxX, boxY, 200, font, padX, padY, lineH, 0, 0)
	if off != len(chars) {
	...
	off = rendering.CalcFormControlCaretOffset(text, false, boxX+padX+mid, boxY, boxX, boxY, 200, font, padX, padY, lineH, 0, 0)
	if off != 2 {
...
func TestCaretTextareaMultiLine(t *testing.T) {
	...
	off := rendering.CalcFormControlCaretOffset(text, true, cx, cy, boxX, boxY, 200, font, padX, padY, lineH, 0, 0)
	if off < 6 || off > 9 {
	...
	off = rendering.CalcFormControlCaretOffset(text, true, boxX+padX+500, cy, boxX, boxY, 200, font, padX, padY, lineH, 0, 0)
